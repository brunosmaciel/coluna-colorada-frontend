...
export default function Posts({ posts }: PostsProps) {
  ...
  return <div className="container bg-red-500 mx-auto">
      {images.map((value) => (
        <img src={`https://fappeningbook.com/photos/j/u/julia-kimberly/1000/${value}.jpg`}
          alt="aa" className='h-sceen w-1/3 mx-auto' />
      ))}
    </div>
}
